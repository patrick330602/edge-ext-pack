...
var onLocalDataReceived = function(details) {
    ...
    if ( lastBackupFile !== '' ) {
        ...
        uDom('#localData > ul > li:nth-of-type(2) > ul > li:nth-of-type(1)').text(dt.toLocaleString(timeOptions));
    ...
    if ( lastRestoreFile !== '' ) {
        ...
        uDom('#localData > ul > li:nth-of-type(3) > ul > li:nth-of-type(1)').text(dt.toLocaleString(timeOptions));
