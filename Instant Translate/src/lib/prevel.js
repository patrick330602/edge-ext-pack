...
(function (win, doc, proto, ael, ge, cn, nn, u, newRegExp, n, ef, uf) {
    ...
    (function () {
        ...
        // Cached checks
        var accessors =
            !!op.__lookupGetter__ && !!op.__lookupSetter__ && !!op.__defineGetter__;
    ...
    (function () {
        ...
        pl.extend({
            ...
            parent: function (elem, step) {
                return step > 0 && elem && elem.parentNode ? pl.parent(elem.parentNode, --step) : elem;
            },
        ...
        pl.extend(pl.fn, {
            ...
            parent: function (step) {
                this.elements = [pl.parent(this.elements[0], step >= 0 ? step : 1)];
                return this;
            },
        ...
        pl.find = (function (_) {
            pl.extend(_, {
                attr: {
                    ...
                    '!=': function (child, attr, value) {
                        return
                        !(attr = child.getAttribute(attr)) || !(new RegExp('(^| +)' + value + '($| +)').test(attr)) ||
                        true;
                    }
                },
                                    ...
                                    while (child = nodes[J++]) {
                                        switch (ancestor) {
                                            ...
                                            case '~':
                                                ...
                                                while (
                                                    (child = child.nextSibling) && !child.yeasss
                                                    ) {
                                                    if (
                                                        child.nodeType == 1 &&
                                                            (
