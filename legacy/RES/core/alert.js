...
var gdAlert = {
	...
	populateContainer: function populateContainer(callback) {
	...
	open: function open(text, callback) {
		if (gdAlert.isOpen) {
			return;
		}
	...
	listenForEscape: function listenForEscape(e) {
		if (e.keyCode === 27) {
			gdAlert.close();
		}
	},
	...
	makeButton: function makeButton(text, cls) {
...
var alert = function alert(text, callback) {
