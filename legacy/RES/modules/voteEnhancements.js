...
addModule('voteEnhancements', function (module, moduleID) {
	...
	module.options = {
		...
		colorCommentScore: {
			...
			presets: {
				'simple': [['0', '#9494FF'], ['1', '#888'], ['2', '#FF8B60']]
			}
		},
	...
	function estimatePostScoreVotes() {
		...
		if (linkinfoScore.length) {
			...
			if (points !== 0 && percentage !== 50) {
				// we can't estimate if percentage equal 50% (i.e. points equal zero) -- It's important to stop don't avoid divide by zero ! edit: if downvote>upvote we can't calculate too
...
//# sourceMappingURL=voteEnhancements.js.map
