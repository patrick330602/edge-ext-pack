 ...
 */
	...
	function getTogglesForMenuItem(menuItemID) {
		...
		var toggles = menuItems.map(function (menuItem) {
	...
	function anyTogglesEnabled(toggles) {
		var enabled = [].concat(toggles).map(function (toggle) {
	...
	module.toggleToggle = function (toggles) {
		toggles = [].concat(toggles).map(function (toggle) {
...
//# sourceMappingURL=customToggles.js.map
