...
addModule('orangered', function (module, moduleID) {
	...
	function updateInboxElements(count, source) {
		...
		$ele.attr('title', count ? 'new mail!' : 'No new mail').toggleClass('havemail', !!count).toggleClass('nohavemail', !count).attr('href', getInboxLink(count));
	}
...
//# sourceMappingURL=orangered.js.map
