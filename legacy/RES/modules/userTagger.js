...
addModule('userTagger', function (module, moduleID) {
  ...
  */
	...
	function registerCommandLine() {
		modules['commandLine'].registerCommand('tag', 'tag [text] - tags author of currently selected link/comment as text', function (command, val, match) {
	...
	function drawUserTagTable(sortMethod, descending) {
		...
		$('#userTaggerTable tbody .deleteIcon').click(function (e) {
			...
			var button = $(this);
			alert('Are you sure you want to delete the tag for user: ' + thisUser + '?', function (e) {
...
//# sourceMappingURL=userTagger.js.map
