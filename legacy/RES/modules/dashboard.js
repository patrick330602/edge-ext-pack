...
addModule('dashboard', function (module, moduleID) {
	...
	function attachEditComponent() {
		...
		$dashboardEditComponent.find('#editRedditForm').submit(function (e) {
			e.preventDefault();
		...
		$dashboardEditComponent.find('#editSearchForm').submit(function (e) {
			e.preventDefault();
		...
		$dashboardEditComponent.find('.cancelButton').click(function (e) {
	...
	function attachAddComponent() {
		...
		$dashboardAddComponent.find('#addRedditForm').submit(function (e) {
			e.preventDefault();
		...
		$dashboardAddComponent.find('#addUserForm').submit(function (e) {
			e.preventDefault();
		...
		$dashboardAddComponent.find('#addSearchForm').submit(function (e) {
			e.preventDefault();
	...
	function addDashboardShortcuts() {
		...
		for (var h = 0, len = subButtons.length; h < len; h++) {
			...
			var exists = module.widgets.some(function (widget) {
				return widget && widget.basePath.toLowerCase() === '/r/' + thisSubredditFragment.toLowerCase();
			});
			if (exists) {
