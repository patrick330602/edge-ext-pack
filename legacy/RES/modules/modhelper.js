	...
	function doStyleSheetCheck() {
		...
		if (stylesheet.length) {
			...
			if (keyNavIdx !== -1) {
				...
				if ((keyNavRule.indexOf('transparent') !== -1 || keyNavRule.indexOf('background: none') !== -1 || keyNavRule.indexOf('background-color: none') !== -1) && keyNavRule.indexOf('border') === -1 && stylesheet.indexOf('.RES-keyNav-activeThing') === -1) {
...
//# sourceMappingURL=modhelper.js.map
