...
addModule('newCommentCount', function (module, moduleID) {
		...
		if (this.isEnabled() && this.isMatchURL()) {
			...
			if (RESUtils.pageType() === 'comments') {
				...
				$(openOnReddit).click(function (event) {
					...
					var ids = $threads.get().map(function (ele) {
						return ele.getAttribute('data-threadid');
					});
	...
	function stopTracking(e) {
		...
		alert('Are you sure you want to stop tracking new comments on post: "' + commentCounts[threadId].title + '"?', function (e) {
...
//# sourceMappingURL=newCommentCount.js.map
